...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button NextButton,
      @NonNull Button ShareButton, @NonNull Guideline guideline5, @NonNull ImageView memeImageView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, NextButton, ShareButton,
          guideline5, memeImageView, progressBar);
    }
